    ...
    return(
        ...
        <div className="template">
          <img src="https://images.pexels.com/photos/7825917/pexels-photo-7825917.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"/>
              <div className="template__content"><h2 className="temp__head--main">WELCOME TO GLAM </h2>
                <h3>LATEST COLLECTION</h3> 
              <div className="template__shop"><Link to="/products" className="Link_style">Shop Now</Link></div></div>
